...
namespace vkontakte
{
    ...
    public class AudioCommands
    {
        ...
        public string SaveAudio(VKSyncMusic.Model.AudioUploadedInfo info)
        {
            NameValueCollection Params = new NameValueCollection();
            string CommandName;
            ...
            return VKSyncMusic.Handlers.Reqeust.POST("https://api.vk.com/method/audio.save", paramsAndtoken);
        }
